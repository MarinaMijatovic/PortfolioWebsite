...
const Javascript: React.FunctionComponent<JavascriptProps> = (props) => {
  ...
  return (
    ...
    >
      <path
       d="M189.158,372.689c9.824,0,16.344-1.585,19.544-4.74c3.2-3.17,4.8-9.6,4.8-19.275v-52.009h-14.296v50.244
      ...
      <g id="Javascript">
        <path
         d="M255.477,361.204c-8.209,0-13.234-0.583-15.073-1.764c-1.839-1.181-2.766-4.396-2.766-9.66l-0.045-1.6h-13.922l0.06,2.751
        ...
        />
        <path
         d="M77.788,0v265.111H42.189v139.614h0.001l35.59,35.591L77.788,490h370.023V102.422L345.388,0H77.788z M395.793,389.413
